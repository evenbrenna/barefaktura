...
describe InvoiceItem do
    ...
    it "accepts , and strips blanks for quantity" do
        expect(FactoryGirl.build(:invoice_item, :quantity => "10 000,00").quantity.to_f).to eq(10000.00)
    end

    it "accepts , and strips blanks for price" do
        expect(FactoryGirl.build(:invoice_item, :unit_price => "10 000,00").unit_price.to_f).to eq(10000.00)
    end
end